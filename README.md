...
A small billing data pipeline. Reads Hive-partitioned CSVs from UpCloud Object Storage, transforms them with dbt, and produces aggregated marts. Documentation, trade-offs, and a discussion of what production would look like are in this README.
